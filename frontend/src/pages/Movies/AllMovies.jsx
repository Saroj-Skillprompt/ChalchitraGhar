        ...
        <section>
          ...
          >
            ...
            <div className="relative z-10 text-center text-white mt-[10rem]">
              <h1 className="text-8xl font-bold mb-4"><span className="text-red-500">Chalchitra</span><span className="text-yellow-500">Ghar</span></h1>
              <p className="text-2xl text-orange-400">
                Make your home the cinema theater
              </p>
            </div>
            ...
            <section className="absolute -bottom-[5rem]">
              <input
                type="text"
                className="w-[100%] h-[5rem] border px-10 outline-none rounded shadow-lg border-gray-600 text-black"
              ...
              <section className="sorts-container mt-[2rem] ml-[10rem]  w-[30rem]">
                <select
                  className="border p-2 rounded text-black  shadow-lg border-gray-600"
                ...
                <select
                  className="border p-2 rounded ml-4 text-black  shadow-lg border-gray-600"
